<template>
    <section class="index_div_wrap">
        ...
        <main class="indexWrap_div_main row">
            ...
            <div :class="['wrapMain_div_center',(save_data || delete_current || export_current) || (add_attr || add_cite || modify_current)?'col-10':'col-10',!module_data?'col-12':'next']">
                <textarea v-show="module_data&&!modify_current" v-html="module_data" class="mainCenter_textarea_code"
                          disabled></textarea>
            ...
            <!--<div v-if="module_data && !modify_current && !add_attr && !add_cite" class="col-2">
              &lt;!&ndash;<p @click.prevent="">导入数据</p>&ndash;&gt;
